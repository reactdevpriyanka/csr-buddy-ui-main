  ...
  describe('validate Pet Profile Title', () => {
   ...
   it('should render food allergies title', () => {
    ...
    it('should create a new pet profile', () => {
      ...
      cy.get(`[data-testid="pet:gender-${sel.petGender}"]`, { timeout: 10 * 1000 })
        .scrollIntoView().click({ force: true });
      ...
      cy.get('[data-testid="add-new-pet-submit"]').click({force:true});
      // cy.wait(2000);
      cy.contains(`Success! Pet profile for ${sel.petName} has been added`).should('exist');
    });
