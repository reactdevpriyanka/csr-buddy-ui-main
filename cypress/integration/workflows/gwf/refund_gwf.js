...
describe.skip('Verify the Replace & Refund Guided Workflow', () => {
  ...
  it('should display all three GWF options', () => {
    ...
    cy.contains('Fix an Issue: Order #' + orderId + '', { timeout: 60000 }).should('be.visible');
    cy.contains('Replacement').should('be.visible');
    cy.contains('Refund').should('be.visible');
    cy.contains('Concession').should('be.visible');
  });

  it('should display items and Select All button when Refund is selected', () => {
    gwfPage.getRefundRadioBtn().click();
    gwfPage.getRefundRadioBtn().should('be.checked');
    ...
    gwfPage.getShelterDonationCheckBox().eq(1).should('be.disabled');
    ...
    gwfPage.getSendBackCheckBox().eq(2).should('be.enabled');
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.enabled');
    cy.contains('Select a quantity to continue', { timeout: 60000 }).should('be.visible');
  });

  it('should display appropriate fields when Select All is selected for Refund', () => {
    ...
    gwfPage.getShelterDonationCheckBox().eq(1).should('be.enabled');
    gwfPage.getPrimaryReasonDropDown().eq(1).parent().should('have.class', 'Mui-disabled');
    gwfPage.getSendBackCheckBox().eq(2).should('be.disabled');
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.disabled');
    cy.get('[data-testid="gwf:multi-item-quantity-minus"].disabled').should('be.visible');
  ...
  it('should be able to select Return Reasons for all items during Refund with Send back', () => {
    ...
    gwfPage.getSendBackCheckBox().eq(2).should('be.checked');
    gwfPage.getSendBackCheckBox().eq(2).should('be.disabled');
    gwfPage.getShelterDonationCheckBox().eq(1).should('be.disabled');
    gwfPage.getShelterDonationCheckBox().eq(1).should('not.be.checked');
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.disabled');
    gwfPage.getShelterDonationCheckBox().eq(3).should('not.be.checked');
  ...
  it('should erase all prefilled return data when Unselect All is selected during Refund', () => {
    ...
    gwfPage.getSendBackCheckBox().eq(2).should('be.enabled');
    gwfPage.getSendBackCheckBox().eq(2).should('not.be.checked');
    gwfPage.getShelterDonationCheckBox().eq(1).should('be.disabled');
    gwfPage.getShelterDonationCheckBox().eq(1).should('not.be.checked');
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.enabled');
    gwfPage.getShelterDonationCheckBox().eq(3).should('not.be.checked');
  ...
  it('should be able to select Return Reasons for all items during Refund with Shelter Donation', () => {
    gwfPage.getSelectAllButton().click();
    cy.contains('div', 'Return Reason').click();
    gwfPage.getReturnReason('Damaged').should('be.visible').click();
    gwfPage.getPrimaryReasonDropDown().eq(0).invoke('text').should('have.string', 'Damaged');
    ...
    gwfPage
      ...
      .should('have.string', 'Dented Box Or Product');
    gwfPage.getAdditionalCommentsTextBox().type('TEST COMMENT');
    gwfPage.getShelterDonationCheckBox().eq(1).check();
    gwfPage.getShelterDonationCheckBox().eq(1).should('be.checked');
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.checked');
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.disabled');
    gwfPage.getSendBackCheckBox().eq(0).should('be.disabled');
    gwfPage.getSendBackCheckBox().eq(0).should('not.be.checked');
    gwfPage.getSendBackCheckBox().eq(2).should('be.disabled');
  ...
  it('should be able to enter Return Reasons for Individual item during Refund with send back', () => {
    ...
    gwfPage
      ...
      .should('have.string', 'Dented Box Or Product');
    gwfPage.getAdditionalCommentsTextBox().type('TEST COMMENT');
    gwfPage.getSendBackCheckBox().eq(2).check();
    gwfPage.getSendBackCheckBox().eq(2).should('be.checked');
    gwfPage.getSendBackCheckBox().eq(0).should('be.disabled');
    gwfPage.getSendBackCheckBox().eq(0).should('not.be.checked');
    gwfPage.getShelterDonationCheckBox().eq(1).should('be.disabled');
  ...
  it('should be able to enter Return Reasons for Individual item during Refund with Shelter Donation', () => {
    gwfPage.getSendBackCheckBox().eq(2).uncheck();
    gwfPage.getSendBackCheckBox().eq(2).should('not.be.checked');
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.enabled');
    gwfPage.getShelterDonationCheckBox().eq(3).check();
    gwfPage.getShelterDonationCheckBox().eq(3).should('be.checked');
    gwfPage.getSendBackCheckBox().eq(0).should('be.disabled');
    gwfPage.getSendBackCheckBox().eq(0).should('not.be.checked');
    gwfPage.getSendBackCheckBox().eq(2).should('be.disabled');
  ...
  it('should not be able to proceed further when no quantity is selected during Refund', () => {
  ...
  it('should erase all prefilled return data when Select All is clicked during Refund', () => {
    gwfPage.getSelectAllButton().click();
    gwfPage.getPrimaryReasonDropDown().eq(0).parent().should('not.have.class', 'Mui-disabled');
    gwfPage.getPrimaryReasonDropDown().eq(0).invoke('text').should('have.string', '');
    gwfPage.getPrimaryReasonDropDown().eq(1).parent().should('have.class', 'Mui-disabled');
  ...
  it('should display appropriate data in Summary Page for Refund without any return or donation', () => {
    cy.intercept({
      method: 'POST',
      url:
    ...
    cy.wait('@paymentDetails').should(({ request, response }) => {
    ...
    cy.get('#gwf-form').within((body) => {
      ...
      cy.contains('Refund Summary').should('be.visible');
      cy.contains('Total Refund').should('be.visible');
  ...
  it('should display appropriate data in Summary Page for Refund with Shelter donation', () => {
    cy.intercept({
      method: 'POST',
      url:
        'https://csrb-gateway.csbb.stg.chewy.com/api/v1/gwf/version/2/name/returns-continueToSummary',
    ...
    gwfPage.getAdditionalCommentsTextBox().clear().type('TEST REFUND COMMENT');
    gwfPage.getViewSummaryButton().click();
    let summary, payDetails;
    cy.wait('@paymentDetails').should(({ request, response }) => {
      summary = response.body.context.summaryDetails;
  ...
  it('should display appropriate data in Summary Page for Refund with Send Back', () => {
    cy.intercept({
      method: 'POST',
      url:
        'https://csrb-gateway.csbb.stg.chewy.com/api/v1/gwf/version/2/name/returns-continueToSummary',
    ...
    gwfPage.getQuestionsLink().click();
    cy.contains('span', 'Summary').should('be.visible');
    gwfPage.getShelterDonationCheckBox().eq(1).uncheck();
    gwfPage.getSendBackCheckBox().eq(0).check();
    cy.contains('All products in this order').click();
    gwfPage.getAdditionalCommentsTextBox().clear().type('TEST REFUND COMMENT');
    gwfPage.getViewSummaryButton().click();
  ...
  it('Verify the request when FedEx Pickup is selected with complaint in summary page', () => {
    ...
    summaryPage.getSpecialRequests().click();
    summaryPage.getDamagedComplaint().click();
    summaryPage.getComplaintTextBox().clear().type('Test Complaint');
    summaryPage.getFrontDoorInstruction().click();
    summaryPage.getInstructionsTextBox().clear().type('Test Instruction');
    summaryPage.getSubmitButton().click();
    cy.wait('@fedExSubmit');
  });
});
